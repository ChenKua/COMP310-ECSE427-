...
void displayCode(int errorCode, char * command){
    ...
    case -6:
        ...
        break;
    case -7:
        printf("ERRORCODE -7 : MOUNT ERROR \n");
        break;
    case -8:
        printf("ERRORCODE -8 : WRITE FILE ERROR \n");
        break;
    case -9:
        printf("ERRORCODE -9 : READ FILE ERROR \n");
        break;
    }
...
{
    printf(
    "\n----------------------------------\nKernel 2.0 loaded!\nWelcome to the KuA Shell!\nShell Version 4.0 Updated Apr 2021\n----------------------------------\n");
    char prompt[15] = {'$','\0'};
    char userinput[1000];
    int errorCode;
